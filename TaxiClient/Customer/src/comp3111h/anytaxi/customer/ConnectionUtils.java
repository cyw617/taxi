...
class ConnectionUtils {
	...
	static void requestCodeHandler(int requestCode, int resultCode,
			Intent intent, Context myActivity) {
		switch (requestCode) {
		...
		default:
			...
			Log.d(LocationUtils.APPTAG, myActivity.getString(
	...
	static boolean servicesConnected(Context myActivity) {
		...
		int resultCode = GooglePlayServicesUtil
				.isGooglePlayServicesAvailable(myActivity);

		// If Google Play services is available
		if (ConnectionResult.SUCCESS == resultCode) {
			// In debug mode, log the status
			Log.d(LocationUtils.APPTAG,
					myActivity.getString(R.string.play_services_available));
	...
	static void connectionResultHandler(ConnectionResult connectionResult,
			Context myActivity) {
		if (connectionResult.hasResolution()) {
			...
			// the error.
			ConnectionUtils.showErrorDialog(connectionResult.getErrorCode(),
					myActivity);
		}
	}
