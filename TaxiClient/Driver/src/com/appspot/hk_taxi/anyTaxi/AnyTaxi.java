...
public class AnyTaxi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public AcceptTransaction acceptTransaction(java.lang.String email, java.lang.Long id) throws java.io.IOException {
    AcceptTransaction result = new AcceptTransaction(email, id);
    initialize(result);
    return result;
  }
  ...
  public class AcceptTransaction extends AnyTaxiRequest<com.appspot.hk_taxi.anyTaxi.model.Transaction> {
    ...
    private static final String REST_PATH = "acceptTransaction/{email}/{id}";
     ...
     * @since 1.13
     */
    protected AcceptTransaction(java.lang.String email, java.lang.Long id) {
    ...
    public AcceptTransaction setEmail(java.lang.String email) {
      this.email = email;
      return this;
    }
   ...
   * @return the request
   */
  public AddTransaction addTransaction(java.lang.String email, com.appspot.hk_taxi.anyTaxi.model.Transaction content) throws java.io.IOException {
    AddTransaction result = new AddTransaction(email, content);
    initialize(result);
    return result;
  }
  ...
  public class AddTransaction extends AnyTaxiRequest<com.appspot.hk_taxi.anyTaxi.model.Transaction> {
    ...
    private static final String REST_PATH = "addTransaction/{email}";
     ...
     * @since 1.13
     */
    protected AddTransaction(java.lang.String email, com.appspot.hk_taxi.anyTaxi.model.Transaction content) {
    ...
    public AddTransaction setEmail(java.lang.String email) {
      this.email = email;
      return this;
    }
   ...
   * @return the request
   */
  public GetDriverLocation getDriverLocation(java.lang.String email, java.lang.Long id) throws java.io.IOException {
    GetDriverLocation result = new GetDriverLocation(email, id);
    initialize(result);
    return result;
  }
  ...
  public class GetDriverLocation extends AnyTaxiRequest<com.appspot.hk_taxi.anyTaxi.model.GeoPt> {
     ...
     * @since 1.13
     */
    protected GetDriverLocation(java.lang.String email, java.lang.Long id) {
    ...
    public GetDriverLocation setEmail(java.lang.String email) {
      this.email = email;
      return this;
    }
   ...
   * @return the request
   */
  public GetTransaction getTransaction(java.lang.String email, java.lang.Long id) throws java.io.IOException {
    GetTransaction result = new GetTransaction(email, id);
    initialize(result);
    return result;
  }
  ...
  public class GetTransaction extends AnyTaxiRequest<com.appspot.hk_taxi.anyTaxi.model.Transaction> {
    ...
    private static final String REST_PATH = "transaction/{email}/{id}";
     ...
     * @since 1.13
     */
    protected GetTransaction(java.lang.String email, java.lang.Long id) {
    ...
    public GetTransaction setEmail(java.lang.String email) {
      this.email = email;
      return this;
    }
   ...
   * @return the request
   */
  public RemoveCustomer removeCustomer(java.lang.String email) throws java.io.IOException {
    RemoveCustomer result = new RemoveCustomer(email);
    initialize(result);
    return result;
  }
  ...
  public class RemoveCustomer extends AnyTaxiRequest<Void> {
     ...
     * @since 1.13
     */
    protected RemoveCustomer(java.lang.String email) {
    ...
    public RemoveCustomer setEmail(java.lang.String email) {
      this.email = email;
      return this;
    }
   ...
   * @return the request
   */
  public RemoveDriver removeDriver(java.lang.String email) throws java.io.IOException {
    RemoveDriver result = new RemoveDriver(email);
    initialize(result);
    return result;
  }
  ...
  public class RemoveDriver extends AnyTaxiRequest<Void> {
     ...
     * @since 1.13
     */
    protected RemoveDriver(java.lang.String email) {
      super(AnyTaxi.this, "DELETE", REST_PATH, null, Void.class);
      this.email = com.google.api.client.util.Preconditions.checkNotNull(email, "Required parameter email must be specified.");
    }
    ...
    public RemoveDriver setEmail(java.lang.String email) {
      this.email = email;
      return this;
    }
   ...
   * @return the request
   */
  public RemoveTransaction removeTransaction(java.lang.String email, java.lang.Long id) throws java.io.IOException {
    RemoveTransaction result = new RemoveTransaction(email, id);
    initialize(result);
    return result;
  }
  ...
  public class RemoveTransaction extends AnyTaxiRequest<Void> {
     ...
     * @since 1.13
     */
    protected RemoveTransaction(java.lang.String email, java.lang.Long id) {
      super(AnyTaxi.this, "DELETE", REST_PATH, null, Void.class);
      this.email = com.google.api.client.util.Preconditions.checkNotNull(email, "Required parameter email must be specified.");
      this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
    }
    ...
    public RemoveTransaction setEmail(java.lang.String email) {
      this.email = email;
      return this;
    }
   ...
   * @return the request
   */
  public UpdateCustomerLocation updateCustomerLocation(java.lang.String email, com.appspot.hk_taxi.anyTaxi.model.GeoPt content) throws java.io.IOException {
    UpdateCustomerLocation result = new UpdateCustomerLocation(email, content);
    initialize(result);
    return result;
  }

  public class UpdateCustomerLocation extends AnyTaxiRequest<com.appspot.hk_taxi.anyTaxi.model.GeoPt> {
     ...
     * @since 1.13
     */
    protected UpdateCustomerLocation(java.lang.String email, com.appspot.hk_taxi.anyTaxi.model.GeoPt content) {
      super(AnyTaxi.this, "PUT", REST_PATH, content, com.appspot.hk_taxi.anyTaxi.model.GeoPt.class);
      this.email = com.google.api.client.util.Preconditions.checkNotNull(email, "Required parameter email must be specified.");
    }
    ...
    public UpdateCustomerLocation setEmail(java.lang.String email) {
      this.email = email;
      return this;
    }
   ...
   * @return the request
   */
  public UpdateDriverLocation updateDriverLocation(java.lang.String email, com.appspot.hk_taxi.anyTaxi.model.GeoPt content) throws java.io.IOException {
    UpdateDriverLocation result = new UpdateDriverLocation(email, content);
    initialize(result);
    return result;
  }

  public class UpdateDriverLocation extends AnyTaxiRequest<com.appspot.hk_taxi.anyTaxi.model.GeoPt> {
     ...
     * @since 1.13
     */
    protected UpdateDriverLocation(java.lang.String email, com.appspot.hk_taxi.anyTaxi.model.GeoPt content) {
      super(AnyTaxi.this, "PUT", REST_PATH, content, com.appspot.hk_taxi.anyTaxi.model.GeoPt.class);
      this.email = com.google.api.client.util.Preconditions.checkNotNull(email, "Required parameter email must be specified.");
    }
    ...
    public UpdateDriverLocation setEmail(java.lang.String email) {
      this.email = email;
      return this;
    }
