		...
		GooglePlayServicesClient.OnConnectionFailedListener
{
	...
	/*
	 * @SmallTest public void testOnRequestListener() { //
	 * getActivity().onStart();
	 * 
	 * Button requestButton = (Button)
	 * getActivity().findViewById(R.id.request_btn);
	 * 
	 ...
	 * assertEquals(redirect.getComponent().getShortClassName(),
	 * ".RequestToTrackingActivity"); }
	 */
	...
	/*
	 * @MediumTest public void testOnConnected() throws Exception { // prepare a
	 * mock location for the location service rLocationClient.connect();
	 * Thread.sleep(5000); rLocationClient.setMockLocation(mockLocation);
	 * 
	 * // connect the activity to GooglePlayService getActivity().onStart();
	 * Thread.sleep(5000);
	 * 
	 * // get the location Location myLocation = null; while (myLocation ==
	 * null) myLocation = getActivity().getLocationClient().getLastLocation();
	 * 
	 * // the location client from the activity is expected to // retrieve the
	 * location as set for the location service assertEquals(mockLocation,
	 * myLocation);
	 * 
